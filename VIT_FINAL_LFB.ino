...
float Kp = 0.08, Ki = 0.0002, Kd = 0.7;
...
void loop() {
  ...
  // ===============================
// ⬅️ LEFT T / SHARP LEFT HANDLING
// ===============================
bool sharpTurn = false;

if (
  (pattern & 0b1111110000000000) == 0b1111110000000000 ||
  (pattern & 0b1111111111100000) == 0b1111111111100000 ||
  (pattern & 0b1111111100000000) == 0b1111111100000000 ||
  (pattern & 0b1111111111111000) == 0b1111111111111000 ||
  (pattern & 0b1111111111110000) == 0b1111111111110000
) {
  ...
  bool frontLine = sensorArray[7] || sensorArray[8] || sensorArray[9] || sensorArray[10];

  // LEFT HAND RULE → LEFT ALWAYS
  if (frontLine) {
    // LEFT T → take LEFT
    motor1run(-90);
    motor2run(200);
...
// ===============================
// ➡️ RIGHT T / SHARP RIGHT HANDLING
// ===============================
else if (
  (pattern & 0b0000000000111111) == 0b0000000000111111 ||
  (pattern & 0b0000000011111111) == 0b0000000011111111 ||
  (pattern & 0b0000000001111111) == 0b0000000001111111 ||
  (pattern & 0b0001111111111111) == 0b0001111111111111 ||
  (pattern & 0b0000111111111111) == 0b0000111111111111) {
